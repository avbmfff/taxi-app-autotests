...
public class TaxiTest extends BaseTest {
    ...
    @Test
    @Order(2)
    public void checkOrderTaxiPage() throws InterruptedException {
    ...
    @Test
    @Order(3)
    public void checkOrderTaxiPageNegative() {
        page.getByText("Такси").click();
    ...
    @Test
    @Order(6)
    void testSidebarLinksFunctionality() {
        page.getByText("Спецоборудование").click();
    ...
    public void testShopsIcons() {
        ...
        Locator backButton = page.locator("a[href='/']");
        backButton.click();
    ...
    public void autorizeTest(){
        ...
        assertTrue(submitButton.isVisible(), "Кнопка 'Зарегистрироваться' не видна");
